        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-auto">
                ...
                <form>
                    ...
                    <input  id="inputFirstName" class="form-control" placeholder="Prénom" required autofocus>
                    
                    <label for="inputLastName" class="visually-hidden">Last name</label>
                    <input  id="inputLastName" class="form-control" placeholder="Nom" required autofocus>
